...
**Last updated:** 2026-06-04 (Phase 4d done)
...
## Phase 4d: README figure gallery — Done

**Goal:** Commit PNG previews under `docs/assets/gallery/` and embed theme + example grids in root and `examples/README.md`.

**Spec:** [`superpowers/specs/2026-06-04-vega-paper-readme-gallery-design.md`](./superpowers/specs/2026-06-04-vega-paper-readme-gallery-design.md)

Delivered:

- `scripts/render-gallery.ts` + `bun run render:gallery` (14 PNGs at `--scale 2`)
- Theme grid in root `README.md`; example gallery in `examples/README.md`
- `scripts/render-gallery.test.ts` asserts committed assets exist
